  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 px-4 h-14 border-b border-border/60">
        <div className="relative h-8 w-8 rounded-md bg-primary flex items-center justify-center text-primary-foreground font-bold glow-amber">
        ...
        {!collapsed && (
          <div className="flex flex-col leading-tight">
            ...
            <span className="text-[10px] text-mono text-muted-foreground">v4.2.1 · DC-01</span>
          </div>
        )}
      </div>
