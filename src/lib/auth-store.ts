...
export const ROLE_DEFINITIONS: Record<UserRole, RoleDefinition> = {
  super_admin: {
    ...
    allowedRoutes: ["/", "/builder", "/inventory", "/inbound", "/putaway", "/picking", "/packing", "/outbound", "/yard", "/qc", "/returns", "/labor", "/reports", "/admin"],
    defaultRoute: "/",
  ...
  warehouse_admin: {
    ...
    allowedRoutes: ["/", "/builder", "/inventory", "/inbound", "/outbound", "/labor", "/reports"],
    defaultRoute: "/",
  ...
  operations_manager: {
    ...
    allowedRoutes: ["/", "/inbound", "/outbound", "/picking", "/labor", "/yard"],
    defaultRoute: "/",
  ...
  inventory_manager: {
    ...
    allowedRoutes: ["/", "/inventory", "/putaway", "/returns"],
  ...
  inbound_supervisor: {
    ...
    allowedRoutes: ["/", "/inbound", "/putaway", "/yard"],
  ...
  outbound_supervisor: {
    ...
    allowedRoutes: ["/", "/picking", "/packing", "/outbound", "/yard"],
  ...
  yard_manager: {
    ...
    allowedRoutes: ["/", "/yard", "/inbound", "/outbound"],
    defaultRoute: "/yard",
    dashboardType: "yard",
  },
  auditor: {
