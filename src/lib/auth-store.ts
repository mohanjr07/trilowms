...
export const ROLE_DEFINITIONS: Record<UserRole, RoleDefinition> = {
  super_admin: {
    ...
    allowedRoutes: ["/", "/orders", "/builder", "/inventory", "/inbound", "/putaway", "/picking", "/consolidation", "/packing", "/outbound", "/yard", "/qc", "/returns", "/labor", "/reports", "/admin"],
    defaultRoute: "/",
  ...
  operations_manager: {
    ...
    allowedRoutes: ["/", "/orders", "/inbound", "/outbound", "/picking", "/labor", "/yard"],
    defaultRoute: "/",
  ...
  outbound_supervisor: {
    ...
    allowedRoutes: ["/", "/orders", "/picking", "/consolidation", "/packing", "/outbound", "/yard"],
  ...
  picker: {
    ...
    allowedRoutes: ["/", "/picking", "/consolidation"],
  ...
  packing_operator: {
    ...
    allowedRoutes: ["/", "/consolidation", "/packing"],
