...
export const ROLE_DEFINITIONS: Record<UserRole, RoleDefinition> = {
  super_admin: {
    ...
    allowedRoutes: ["/", "/orders", "/builder", "/inventory", "/inbound", "/putaway", "/scan-putaway", "/picking", "/scan-pick", "/consolidation", "/packing", "/scan-pack", "/outbound", "/ptl", "/yard", "/qc", "/returns", "/labor", "/reports", "/admin"],
    defaultRoute: "/",
  ...
  operations_manager: {
    ...
    allowedRoutes: ["/", "/orders", "/inbound", "/outbound", "/ptl", "/picking", "/scan-pick", "/labor", "/yard"],
    defaultRoute: "/",
  ...
  outbound_supervisor: {
    ...
    allowedRoutes: ["/", "/orders", "/picking", "/scan-pick", "/consolidation", "/packing", "/scan-pack", "/outbound", "/ptl", "/yard"],
