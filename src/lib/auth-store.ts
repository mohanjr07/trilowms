...
export const ROLE_DEFINITIONS: Record<UserRole, RoleDefinition> = {
  super_admin: {
    ...
    allowedRoutes: ["/", "/orders", "/builder", "/inventory", "/inbound", "/putaway", "/picking", "/packing", "/outbound", "/yard", "/qc", "/returns", "/labor", "/reports", "/admin"],
    defaultRoute: "/",
  ...
  outbound_supervisor: {
    ...
    allowedRoutes: ["/", "/orders", "/picking", "/packing", "/outbound", "/yard"],
