...
export const ROLE_DEFINITIONS: Record<UserRole, RoleDefinition> = {
  super_admin: {
    ...
    allowedRoutes: ["/", "/orders", "/builder", "/inventory", "/inbound", "/putaway", "/scan-putaway", "/picking", "/scan-pick", "/consolidation", "/packing", "/outbound", "/yard", "/qc", "/returns", "/labor", "/reports", "/admin"],
    defaultRoute: "/",
